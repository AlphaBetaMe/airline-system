    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="d-flex mb-4">
                {{-- adds on form --}}
                <input type="checkbox" class="d-none" id="baggage_checkbox" name="baggage_adds_on">
                <div class="card rounded" style="width: 100%">
                    <div class="card-body d-flex align-items-center">
                        <div class="d-flex align-items-center">
                            <svg fill="#d5b72b" height="75px" width="75px" version="1.1" id="Layer_1"
                ...
                <button id="baggage_button_add" type="button" class="btn px-5 btn-primary">ADD</button>
            </div>
            ...
            <div class="d-flex ">
                {{-- adds on form --}}
                <input type="checkbox" class="d-none" id="selector_checkbox" name="selector_adds_on">
                <div class="card rounded" style="width: 100%">
                    <div class="card-body d-flex align-items-center">
                        <div class="d-flex align-items-center">
                            <svg fill="#d5b72b" width="75px" height="75px" viewBox="0 0 512 512"
                        ...
                        <p class="card-text ms-5">
                            Window or aisle seat? Want to sit with your group or get extra legroom? Select a seat now!
                        </p>
                    </div>
                </div>
                <button id="selector_button_add" type="button" class="btn px-5 btn-primary">ADD</button>
            </div>

            @include('user.booking-steps.adds-on.seat-selection')

            <div class="mt-4 d-flex justify-content-end">
                <button type="button" onclick="prevStep(1)" class="btn btn-lg btn-danger">Back</button>
                <button type="button" class="btn btn-lg ms-3 btn-primary" data-bs-toggle="modal"
...
<script>
    ...
    const baggage_checkbox = document.getElementById('baggage_checkbox');
    const baggage_button_add = document.getElementById('baggage_button_add');
    ...
    baggage_button_add.addEventListener('click', function() {
        // Check the checkbox
        baggage_checkbox.checked = !baggage_checkbox.checked;
    ...
    // Add click event listener to the button
    selector_button_add.addEventListener('click', function() {
        // Check the checkbox
        selector_checkbox.checked = !selector_checkbox.checked;
           // Change the button text based on checkbox state
           if (selector_checkbox.checked) {
                selector_button_add.textContent = 'ADDED ✓';
            } else {
