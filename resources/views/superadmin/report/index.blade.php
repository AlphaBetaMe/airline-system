...
<div class="container-fluid" id="container-wrapper">
    ...
    <form action="{{ route('report.index') }}" method="get" id="filterForm">
        ...
        <div class="form-group" id="returnDateGroup" style="display: {{ request('flight_type') === 'round_trip' ? 'block' : 'none' }};">
            <label for="departure_date_return">Filter by Return Date:</label>
            <input type="date" class="form-control" name="departure_date_return" id="departure_date_return" value="{{ request('departure_date_return') }}">
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="flight_type" id="flight_type">
                ...
                <option value="round_trip" @if(request('flight_type') === 'round_trip') selected @endif>Round Trip</option>
            </select>
        </div>
                            ...
                            <tbody>
                                @foreach ($fullyBookedPassengers as $book)
                                    ...
                                    <tr>
                                        ...
                                        <td>₱{{ $book->price * $numberofPassengers + $baggage_sum + $total_seat_price }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
